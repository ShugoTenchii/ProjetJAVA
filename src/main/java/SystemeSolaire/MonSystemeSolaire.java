...
public class MonSystemeSolaire {
    ...
    public static Astre Soleil = new Astre("Soleil", 0,0,2, 0,0,  StdDraw.PRINCETON_ORANGE, Horloge);
    public static Astre Terre = new Astre("Terre", 0.85,0, 0.85,365, 0.025, StdDraw.BOOK_BLUE, Horloge);
    public static Astre Mars = new Astre("Mars",1.0,0,1,686, 0.2, StdDraw.BOOK_RED, Horloge);
