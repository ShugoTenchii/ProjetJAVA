...
public class Astre extends JPanel{
    ...
    public Astre(String nom, double coordX, double coordY, double rayon, int periodeRevolution, double angleVitesse, double taille, Color couleur, HorlogeUniverselle Horloge) {
        this.nom = nom;
        this.coordX = coordX;
        this.coordY = coordY;
        this.rayon = rayon;
    ...
    public void deplacePosition(HorlogeUniverselle Horloge){
        ...
        StdDraw.show();
        HorlogeUniverselle.pause(360/Horloge.getCombienDejour());
    }
